...
class ModelArguments:
    ...
    vlora_groups: Optional[int] = field(default=1)
    ...
    vlora_llm_groups: Optional[int] = field(default=1)
    vlora_rank: Optional[int] = field(default=2)
    vlora_type: Optional[str] = field(default="qkvom")
    vlora_type_group: Optional[str] = field(default="kv")
    vlora_groups: Optional[int] = field(default=1)
    ...
    if model_args.vision_tower is not None:
        if "mpt" in model_args.model_name_or_path:
            ...
            if 'vicuna' in model_args.model_name_or_path:
                ...
                model = LlavaQwen2VLoRAForCausalLM.from_pretrained(
                    model_args.model_name_or_path,
                    cache_dir=training_args.cache_dir,
